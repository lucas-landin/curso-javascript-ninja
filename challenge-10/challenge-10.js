...
if(sub){
    var  num1 = 100
    var  num2 = 20
    console.log(showOperationMessage(operationSignal,num1,num2), sub(num1,num2) )
  }
  else{
  console.log(showErrorMessage(operationSignal))
  };
  ...
  operationSignal ='*';
  var vez = calculator(operationSignal)
  if(vez){
    var  num1 = 10
    var  num2 = 20
    console.log(showOperationMessage(operationSignal,num1,num2), vez(num1,num2) )
  }
  else{
  console.log(showErrorMessage(operationSignal))
  };
