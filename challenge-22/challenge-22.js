...
/*
  ...
  */
  var lucas = {name: 'Lucas', lastname: 'Landin'};
  var matheus = {name: 'Matheus', lastname:'Neder'};
  ...
  */
  ...
  function getFullName (){
   ...
   getFullName.call(lucas);
   getFullName.call(matheus);
  /*
  ...
  */
  ...
  console.log(justNumbers('asddas 555 asdasda444'))
