...
var meuNome = text.replace('Manuel Marques de Sousa','Neidola Delas')
console.log(meuNome);
/*
...
var bairrismo = meuNome.replace('brasileiro','Angolano')
console.log(bairrismo)
/*
...
var numSub = bairrismo.replace(/\d/g, '-')
console.log(numSub);
/*
...
var dporh = bairrismo.replace(/[D-Za-h]/g, '0')
console.log(dporh)
/*
...
var apor4 = bairrismo.replace(/a/gi, '4')
console.log(apor4);
/*
...
var apelido = text.replace(/'centauro de luvas'/g, function(frase){
...
function getMonthNumber(nummes){
var meses = {
    janeiro: '01',
    fevereiro: '02',
    'março': '03', 
